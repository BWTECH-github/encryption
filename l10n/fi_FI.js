OC.L10N.register(
    ...
    "You need to migrate your encryption keys from the old encryption (version 8.0 and older) to the new one. Please run 'occ encryption:migrate' or contact your administrator" : "Salausavaimet tulee siirtää vanhasta salaustavasta (owncloud.online <= 8.0) uuteen salaustapaan. Suorita 'occ encryption:migrate' tai ota yhteys ylläpitoon",
    ...
    "owncloud.online basic encryption module" : "owncloud.onlinein perussalausmoduuli",
