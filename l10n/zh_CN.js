OC.L10N.register(
    ...
    "You need to migrate your encryption keys from the old encryption (version 8.0 and older) to the new one. Please run 'occ encryption:migrate' or contact your administrator" : "你需要从旧版本 (owncloud.online <= 8.0) 迁移你的加密密钥，请运行 `occ encryption:migrate` 或联系管理员。",
    ...
    "Hey there,\n\nthe admin enabled server-side-encryption. Your files were encrypted using the password '%s'.\n\nPlease login to the web interface, go to the section 'owncloud.online basic encryption module' of your personal settings and update your encryption password by entering this password into the 'old log-in password' field and your current login-password.\n\n" : "您好，\n\n管理员启用了服务器端加密。你的文件已被用密码 '%s' 加密。\n\n请登录到网页界面，在你的个人设置中找到“owncloud.online 基础加密模块”一节，将此密码填入“旧的登录密码”框内，再填写当前的登录密码以更新你的加密密码。\n\n",
    "The share will expire on %s." : "此分享将在 %s 过期。",
    "Cheers!" : "干杯！",
    "Hey there,<br><br>the admin enabled server-side-encryption. Your files were encrypted using the password <strong>%s</strong>.<br><br>Please login to the web interface, go to the section \"owncloud.online basic encryption module\" of your personal settings and update your encryption password by entering this password into the \"old log-in password\" field and your current login-password.<br><br>" : "您好，<br><br>管理员启用了服务器端加密。你的文件已被用密码 <strong>%s</strong> 加密。<br><br>请登录到网页界面，在你的个人设置中找到“owncloud.online 基础加密模块”一节，将此密码填入“旧的登录密码”框内，再填写当前的登录密码以更新你的加密密码。<br><br>",
    ...
    "owncloud.online basic encryption module" : "owncloud.online 基础加密模块",
