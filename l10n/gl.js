OC.L10N.register(
    ...
    "Hey there,\n\nthe admin enabled server-side-encryption. Your files were encrypted using the password '%s'.\n\nPlease login to the web interface, go to the section 'owncloud.online basic encryption module' of your personal settings and update your encryption password by entering this password into the 'old log-in password' field and your current login-password.\n\n" : "Ola,\n\nO administrador activou o cifrado do lado do servidor. Os seus ficheiros cifraránse co contrasinal «%s».\n\nIdentifíquese na interface web, vaia á sección «Módulo básico de cifrado do owncloud.online» dos seus axustes personais e actualice o seu contrasinal escribindo este contrasinal no campo «Contrasinal antigo de acceso» e introducindo a nova no seu correspondente campo.\n\n",
    "The share will expire on %s." : "Esta compartición caduca o %s.",
    "Cheers!" : "Saúdos!",
    "Hey there,<br><br>the admin enabled server-side-encryption. Your files were encrypted using the password <strong>%s</strong>.<br><br>Please login to the web interface, go to the section \"owncloud.online basic encryption module\" of your personal settings and update your encryption password by entering this password into the \"old log-in password\" field and your current login-password.<br><br>" : "Ola,<br><br>O administrador activou o cifrado do lado do servidor. Os seus ficheiros cifraránse co contrasinal <strong>%s</strong>.<br><br>Identifíquese na interface web, vaia á sección «Módulo básico de cifrado do owncloud.online» dos seus axustes personais e actualice o seu contrasinal escribindo este contrasinal no campo «Contrasinal antigo de acceso» e introducindo a nova no seu correspondente campo.<br><br>",
    ...
    "owncloud.online basic encryption module" : "Módulo básico de cifrado de owncloud.online",
